...
const Footer = () => {
  return (
    <footer className="bg-white border-t border-gray-200">
      <div className="max-w-[2560px] mx-auto px-4 lg:px-6 xl:px-8 [@media(min-width:1440px)]:ml-[72px]">
        <div className="py-4 md:py-6">
          <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-8">
            {/* Company Info */}
            <div className="col-span-2">
              <h3 className="text-lg font-semibold mb-4">BeyondChats</h3>
              <p className="text-gray-600 text-sm mb-4 max-w-md">
                Modern customer communications platform that helps you build better relationships with your customers.
              </p>
              <div className="flex items-center text-sm text-gray-600">
                <span>Made with</span>
                <Heart size={16} className="mx-1 text-red-500" />
                <span>by the BeyondChats team</span>
              </div>
            </div>

            {/* Product Links */}
            <div className="space-y-3">
              <h4 className="font-medium text-sm text-gray-900">Product</h4>
            ...
            {/* Company */}
            <div className="space-y-3">
              <h4 className="font-medium text-sm text-gray-900">Company</h4>
              <ul className="space-y-2 text-sm">
            ...
            {/* Legal */}
            <div className="space-y-3">
              <h4 className="font-medium text-sm text-gray-900">Legal</h4>
              <ul className="space-y-2 text-sm">
